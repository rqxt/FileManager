...
public class MsgPrintThread extends Thread {
	...
	public void run() {
		...
		WestShowStatePanel.msgLeftLabel.setText("工作");
		...
		BottomButtonPanel.southReLoad.setVisible(true);
		WestShowStatePanel.msgLeftLabel.setText("完成");
		CenterMainPanel.centerScrollPane.revalidate();
		CenterMainPanel.centerScrollPane.repaint();
